...
export const PaymentWithoutButton = () => {
        ...
        return {
            ...
            onAuthorize: (data, actions) => {
                return actions.payment.execute().then(function (res) {
                    ...
                    dispatch(paymentSuccess(order, payment, checkbox, paymentMethod)) // call my PaymentSucess action
                });
            }
    ...
    return (
        <div id="paypal-button" style={{opacity:"0"}}></div>
    )
